...
begin
  ...
  Reg.WriteString('CfgPorta', '1 porta / L1 = Entrada / L2 = Saída');
  Reg.WriteString('CfgFluxoCatraca_1', 'Entrada com cartão');
  Reg.WriteString('CfgFluxoCatraca_2', 'Saída com cartão');
